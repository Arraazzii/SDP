        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    <li>Dashboard</li>
                    <li>Laporan</li>
                    <li class="active">Rekapitulasi K3</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Data K3 Perusahaan</strong>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <form class="form-inline" action="<?php echo base_url()?>Admin/report_k3" target="_blank" method="post" style="width:100%;">
                                <div class="col-sm-1">
