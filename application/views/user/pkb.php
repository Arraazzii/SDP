            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header card-header-info">
                        <h4 class="card-title">Edit PKB</h4>
                        <p class="card-category">Lengkapi Surat PKB Anda</p>
                    </div>
                    <div class="card-body">
                        <form enctype="multipart/form-data" action="<?php echo base_url('User/uploadPkb');?>" method="post" >
                            <?php if ($get_pkb == NULL) {?>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <?php }else{
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>No. Dokumen</label>
                                                <input type="text" class="form-control" name="no_dokumen" required="" value="<?php echo $get_pkb[0]['no_dokumen'];?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">No. Registrasi</label>
                                                <input type="text" class="form-control" name="no_registrasi" required="" value="<?php echo $get_pkb[0]['no_registrasi'];?>">
                                            </div>
                                        </div>
                                    </div>
                                    <input type="hidden" name="id" value="<?php echo $get_pkb[0]['id'];?>">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Tanggal Daftar</label>
                                                <input type="date" class="form-control" name="tanggal" required="" value="<?php echo $get_pkb[0]['tanggal_daftar'];?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <!-- Standar Form -->
                                            ...
                                            <!-- <form action="" method="POST" enctype="multipart/form-data"> -->
                                                ...
                                                <br>
                                                <a href="<?php echo base_url('upload/pkb/' .$get_pkb[0]['nama_file']);?>" class="text-danger"> File : <?php echo $get_pkb[0]['nama_file'];?></a><br>
                                                <!-- <button type="submit" class="btn btn-sm btn-info">Upload Berkas</button> -->
                                                <!-- </form> -->
                                            </div>
                                        </div>
                                        <?php } ?>
                                        <button type="submit" class="btn btn-info pull-right">Perbarui pkb</button>
                        ...
                        <div class="col-md-4">
                            <div class="card card-profile">
                                <?php if ($get_pkb == NULL) {?>
                                <div class="card-body">
                                    <h6 class="card-category text-gray">ANDA BELUM MENGIRIM / MEMPERBAHARUI PKB</h6>
                                    <h4 class="card-title"> (PKB)</h4>
                                </div>
                                <?php }else{ ?>
                                <div class="card-avatar" style="border-radius: 0px;max-width: 100%;max-height: 100%;">
                                    <a href="#pablo">
                                        <object data="<?php echo base_url('upload/pkb/' .$get_pkb[0]['nama_file']);?>" type="application/pdf" width="100%" height="100%">
                                        </object>
                                    </a>
                                </div>
                                <div class="card-body">
                                            ...
                                            <?php }else{
                                                ...
                                                foreach($detail_pkb as $detail){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url('upload/pkb/' .$detail['nama_file']);?>" class="btn btn-info" target="_blank">Download</a>
                                                        </td>
                                                    </tr>
                                                    <?php } } ?>
                                                </tbody>
