...
class User extends CI_Controller {
    ...
    public function uploadPp(){
        ...
        {   
            ...
            $this->session->set_flashdata('notif', '<div class="alert alert-success alert-dismissible"> 
            Success! PP Berhasil Ditambahkan.
            <button type="button" class="close" data-dismiss="alert">&times</button>
                                                </div>');
        ...
        else
        {
           ...
           $this->session->set_flashdata('notif', '<div class="alert alert-success alert-dismissible"> 
            Success! PP Berhasil Diperbaharui.
            <button type="button" class="close" data-dismiss="alert">&times</button>
                                                </div>');
           redirect('User/pp', 'refresh');
       }
   ...
   public function uploadPkb(){
    ...
    {   
        ...
        $this->session->set_flashdata('notif', '<div class="alert alert-success alert-dismissible"> 
            Success! PKB Berhasil Ditambahkan.
            <button type="button" class="close" data-dismiss="alert">&times</button>
                                                </div>');
    ...
    else
    {
       ...
       $this->session->set_flashdata('notif', '<div class="alert alert-success alert-dismissible"> 
            Success! PKB Berhasil Diperbaharui.
            <button type="button" class="close" data-dismiss="alert">&times</button>
                                                </div>');
       redirect('User/pkb', 'refresh');
   }
...
public function uploadLks(){
    ...
    {   
        ...
        $this->session->set_flashdata('notif', '<div class="alert alert-success alert-dismissible"> 
            Success! LKS Berhasil Ditambahkan.
            <button type="button" class="close" data-dismiss="alert">&times</button>
                                                </div>');
    ...
    else
    {
       ...
       $this->session->set_flashdata('notif', '<div class="alert alert-success alert-dismissible"> 
            Success! LKS Berhasil Diperbaharui.
            <button type="button" class="close" data-dismiss="alert">&times</button>
                                                </div>');
       redirect('User/lks', 'refresh');
   }
...
public function uploadK3(){
    ...
    {   
        ...
        $this
        ->db
        ->insert('table_k3', $insert);

        $this->session->set_flashdata('notif', '<div class="alert alert-success alert-dismissible"> 
            Success! K3 Berhasil Ditambahkan.
            <button type="button" class="close" data-dismiss="alert">&times</button>
                                                </div>');
    ...
    else
    {
       ...
       $this->session->set_flashdata('notif', '<div class="alert alert-success alert-dismissible"> 
            Success! K3 Berhasil Diperbaharui.
            <button type="button" class="close" data-dismiss="alert">&times</button>
                                                </div>');
       redirect('User/k3', 'refresh');
   }
...
public function uploadWlkp(){
    ...
    {   
        ...
        $this
        ->db
        ->insert('table_wlkp', $insert);

        $this->session->set_flashdata('notif', '<div class="alert alert-success alert-dismissible"> 
            Success! WLKP Berhasil Ditambahkan.
            <button type="button" class="close" data-dismiss="alert">&times</button>
                                                </div>');
    ...
    else
    {
       ...
       $this->session->set_flashdata('notif', '<div class="alert alert-success alert-dismissible"> 
            Success! WLKP Berhasil Diperbaharui.
            <button type="button" class="close" data-dismiss="alert">&times</button>
                                                </div>');
       redirect('User/wlkp', 'refresh');
   }
